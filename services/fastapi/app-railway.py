...
# Try to import ML libraries, fallback to simple alternatives
try:
...
try:
    ...
    print("Warning: FAISS not available, using simple similarity")
...
try:
    ...
    print("Warning: LightGBM not available, using sklearn")
...
app = FastAPI(title="Chyll FastAPI MVP - Railway Optimized")
...
# ---- Config
SIRENE_MODE = os.getenv("SIRENE_MODE", "demo")  # Default to demo for Railway
...
# Simplified similarity without heavy ML
...
def health(): 
    return {
        "ok": True, 
        "service": "chyll-fastapi-railway", 
        "sirene_mode": SIRENE_MODE,
        "ml_available": ML_AVAILABLE,
        "faiss_available": FAISS_AVAILABLE,
        "classifier_available": ML_CLASSIFIER_AVAILABLE
    }
...
def train(req: TrainRequest):
    ...
    if ML_CLASSIFIER_AVAILABLE:
        base = LGBMClassifier(n_estimators=100, learning_rate=0.1)
    else:
    ...
    return {
        ...
        "model_version": f"{tenant}-v1-railway"
    }
...
def discover(req: DiscoverRequest):
    ...
    limit = int(req.limit or 1000)  # Reduced limit for Railway
    
    # Demo data for Railway version
    items = [
        ...
        {"company_name":"TECH STARTUP","siren":"777888999","website":"techstartup.fr","ape":"6201Z","region":"11","department":"75","created_year":2023},
        {"company_name":"INNOVATION CORP","siren":"123456789","website":"innovation-corp.com","ape":"6202A","region":"11","department":"92","created_year":2020},
    ]
