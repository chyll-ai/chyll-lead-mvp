...
app = FastAPI(title="Chyll FastAPI MVP - Lightweight")
...
# ---- Config
SIRENE_MODE = os.getenv("SIRENE_MODE", "demo")  # Default to demo for lightweight version
...
def health(): 
    return {
        "ok": True, 
        "service": "chyll-fastapi-lightweight", 
...
def train(req: TrainRequest):
    ...
    return {
        ...
        "model_version": f"{tenant}-v1-lightweight"
    }
...
def discover(req: DiscoverRequest):
    ...
    limit = int(req.limit or 1000)  # Reduced limit for lightweight version
    
    # Demo data for lightweight version
    items = [
